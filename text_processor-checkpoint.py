...
def main():
    ...
    **✅ 사용 방법:**
    ...
    4. *양천일염 님의 롤20 API as_autofiller.js (`https://kibkibe.github.io/roll20/`) 명령어 사용을 가정하고 대사 처리하였습니다.*
    """)
    ...
    example_output = '''예를 들어서,
이런 것은 스크립트로 분류 됩니다!
또 다른 스크립트 문장입니다.
!!Theo Hello. How are you?
위 문장은 대사로 분류되어 중간에 줄바꿈되지 않습니다.
이런 식으로 문단을 통으로 넣으면,
알아서 롤20 채팅창에 붙여넣기 좋게 나눠줍니다.'''
